 ...
 * até o momento da aplicação da sua primeira prova. Acostumada a dar notas de 0 (zero) a 100 
 * (cem), ela fez o mesmo na primeira prova da sua turma da Alemanhã. No entanto, os estudante 
 * acharam estranho, uma vez que na Alemanhã o sistema de notas é diferente: as notas devem ser 
 * dadas como conceitos de A a E. O conceito A é o mais alto, enquanto o conceito E é o mais 
 * baixo.
 * 
 ...
 * notas para o sistema de letras. No entanto, Norminia precisa preparar as próximas atividades 
 * educacionais para os seus alunos, e não tem tempo suficiente para fazer a conversão das notas 
 * manualmente.
 * 
